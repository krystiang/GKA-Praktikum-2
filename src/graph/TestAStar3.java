...
public class TestAStar3 {
		...
		try {
			undirected =
					(UndirectedGraph<AttrVertex, DefaultEdge>) asCounting(newUndirectedWeightedAttributedReader().read(
							Root.pathToSource + "a2_p04_ar_vb/misc/autobahn.gka"), undirectedcounts,
	...
	public void testAStar() throws IOException {
		...
		GraphPath<AttrVertex, DefaultEdge> undirectedPath =
				undirectedFinder.apply(undirected, new AttrVertex("Saarbrücken"), new AttrVertex("Würzburg"));
		
		System.out.println("AStar Saarbrücken -> Würzburg");
