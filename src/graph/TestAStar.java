...
public class TestAStar {
	...
	public void testAStar() throws IOException {
		...
		System.out.println("AStar Husum -> Hamburg");
		...
		GraphVizPFinder.erzeugeDot("HusumHamburgAStar",undirected, undirectedPath);
		System.out.println("---------------------------");
		...
		System.out.println("AStar Minden -> Hamburg");
		System.out.println(undirectedCounter);
		System.out.println(undirectedcounts);
		undirectedcounts.clear();
		undirectedCounter.clear();
		...
		System.out.println("AStar Münster -> Hamburg");
		System.out.println(undirectedCounter);
		System.out.println(undirectedcounts);
		undirectedcounts.clear();
		undirectedCounter.clear();
